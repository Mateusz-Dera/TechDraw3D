...
def run_faceplacer():
    ...
    process = subprocess.Popen(["blender", "-b", "--python",  "/home/jschwarz/Projekty/Prywatne/TechDraw3D/libs/faceplacer/part2.py"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    out, err = process.communicate()

    process = subprocess.Popen(["blender", "-b", "--python",  "/home/jschwarz/Projekty/Prywatne/TechDraw3D/libs/faceplacer/part3.py"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    out, err = process.communicate()
